  ...
  if (!b) throw new Error("bootstrap-datetimepicker requires Moment.js to be loaded first");var c = function c(_c, d) {
    var e,
      ...
      o && (a && (i = Math.max(p, Math.min(3, i + a))), o.find(".datepicker > div").hide().filter(".datepicker-" + q[i].clsName).show());
        ...
        K = function K() {
      var b = a("<tr>"),
          c = l.clone().startOf("w").startOf("d");for (d.calendarWeeks === !0 && b.append(a("<th>").addClass("cw").text("#")); c.isBefore(l.clone().endOf("w"));) {
      ...
      var b = o.find(".timepicker-hours table"),
          c = l.clone().startOf("d"),
          d = [],
          e = a("<tr>");for (l.hour() > 11 && !f && c.hour(12); c.isSame(l, "d") && (f || l.hour() < 12 && c.hour() < 12 || l.hour() > 11);) {
      ...
      o && (U(), Y());
        ...
        $ = function $(a) {
      var b = m ? null : k;return a ? (a = a.clone().locale(d.locale), 1 !== d.stepping && a.minutes(Math.round(a.minutes() / d.stepping) * d.stepping % 60).seconds(0), void (P(a) ? (k = a, l = k.clone(), e.val(k.format(g)), _c.data("date", k.format(g)), m = !1, Z(), H({ type: "dp.change", date: k.clone(), oldDate: b })) : (d.keepInvalid || e.val(m ? "" : k.format(g)), H({ type: "dp.error", date: a })))) : (m = !0, e.val(""), _c.data("date", ""), H({ type: "dp.change", date: !1, oldDate: b }), void Z());
    },
        _ = function _() {
      ...
      var c = a(b.target).val().trim(),
        ...
        ja = function ja() {
      e.on({ change: ia, blur: d.debug ? "" : _, keydown: ga, keyup: ha, focus: d.allowInputToggle ? da : "" }), _c.is("input") ? e.on({ focus: da }) : n && (n.on("click", ea), n.on("mousedown", !1));
    },
        ka = function ka() {
      e.off({ change: ia, blur: _, keydown: ga, keyup: ha, focus: d.allowInputToggle ? _ : "" }), _c.is("input") ? e.off({ focus: da }) : n && (n.off("click", ea), n.off("mousedown", !1));
    },
        la = function la(b) {
      ...
      _(), ka(), _c.removeData("DateTimePicker"), _c.removeData("date");
    ...
    }, _c.is("input"))) e = _c;else if ((e = _c.find(d.datepickerInput), 0 === e.size())) e = _c.find("input");else if (!e.is("input")) throw new Error('CSS class "' + d.datepickerInput + '" cannot be applied to non input element');if ((_c.hasClass("input-group") && (n = 0 === _c.find(".datepickerbutton").size() ? _c.find('[class^="input-group-"]') : _c.find(".datepickerbutton")), !d.inline && !e.is("input"))) throw new Error("Could not initialize DateTimePicker without an input element");return a.extend(!0, d, F()), j.options(d), na(), ja(), e.prop("disabled") && j.disable(), e.is("input") && 0 !== e.val().trim().length ? $(fa(e.val().trim())) : d.defaultDate && void 0 === e.attr("placeholder") && $(d.defaultDate), d.inline && da(), j;
